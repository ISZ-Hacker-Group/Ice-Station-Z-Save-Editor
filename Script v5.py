...
DebugData2.geometry("360x260")

DebugData3 = Tk()
DebugData3.title('Data3 (Options) Editor')
DebugData3.geometry("360x200")

DebugData1 = Tk()
DebugData1.title('Data1 (Save Slot 2) Editor')
DebugData1.geometry("360x260")

DebugData0 = Tk()
DebugData0.title('Data0 (Save Slot 1) Editor')
DebugData0.geometry("360x260")

data_in_byte = b'\x08'
def myClick100():
    message87 = Label(root1, text="Data0 (Slot 1): MilitaryXXX Armour Set - Debugger")
    message87.pack()
...
data_in_byte = b'\x08'
def myClick101():
    message87 = Label(root1, text="Data1 (Slot 2): MilitaryXXX Armour Set - Debugger")
    message87.pack()
    #Edit Data in Bytes Code.
    data_in_byte = b'\x08' 
    #Bytes to write to file
    ...
    with open(DebugData1, 'rb+') as binary_file:
      #open file as binary
      binary_file.seek(60) 
      #Move Editing to Offset 33
      binary_file.write(data_in_byte) 
...
data_in_byte = b'\x08'
def myClick102():
    message87 = Label(root1, text="Data2 (Slot 3): MilitaryXXX Armour Set - Debugger")
    message87.pack()
    #Edit Data in Bytes Code.
    data_in_byte = b'\x08' 
    #Bytes to write to file
...
data_in_byte = b'\x05'
def myClick103():
    message87 = Label(root1, text="Data0 (Slot 1): Kvlar + MilitaryXX Backpack Set - Debugger")
    message87.pack()
    #Edit Data in Bytes Code.
    data_in_byte = b'\x05' 
    #Bytes to write to file
...
data_in_byte = b'\x05'
def myClick104():
    message87 = Label(root1, text="Data1 (Slot 2): Kvlar + MilitaryXX Backpack Set - Debugger")
    message87.pack()
    #Edit Data in Bytes Code.
    data_in_byte = b'\x05' 
    #Bytes to write to file
...
data_in_byte = b'\x05'
def myClick105():
    message87 = Label(root1, text="Data2 (Slot 3): Kvlar + MilitaryXX Backpack - Debugger")
    message87.pack()
    #Edit Data in Bytes Code.
    data_in_byte = b'\x05' 
    #Bytes to write to file
...
def myClick87():
    message87 = Label(root1, text="Data0 (Slot 1): Attempted Resoration Completed - Debugger")
    message87.pack()
    #Edit Data in Bytes Code.
    data_in_byte = b'\x01\x00\x00\x00' 
    #Bytes to write to file
...
data_in_byte = b'\x01\x00\x00\x00'
def myClick88():
    message88 = Label(root1, text="Data1 (Slot 2): Attempted Resoration Completed - Debugger")
    message88.pack()
    #Edit Data in Bytes Code.
    data_in_byte = b'\x01\x00\x00\x00' 
    #Bytes to write to file
...
data_in_byte = b'\x01\x00\x00\x00'
def myClick89():
    message89 = Label(root1, text="Data2 (Slot 3): Attempted Resoration Completed - Debugger")
    message89.pack()
    #Edit Data in Bytes Code.
    data_in_byte = b'\x01\x00\x00\x00' 
    #Bytes to write to file
...
myButton100 = Button(DebugData0, text="Data0 (Save Slot 1): MilitaryXXX Armour", command=myClick100, fg="orange", bg="black")
myButton100.pack()

myButton101 = Button(DebugData1, text="Data1 (Save Slot 2): MilitaryXXX Armour", command=myClick101, fg="orange", bg="black")
myButton101.pack()

myButton102 = Button(DebugData2, text="Data2 (Save Slot 3): MilitaryXXX Armour", command=myClick102, fg="orange", bg="black")
myButton102.pack()

myButton103 = Button(DebugData0, text="Data0 (Save Slot 1): Kvlar Armour + MilitaryXXX Backpack", command=myClick103, fg="orange", bg="black")
myButton103.pack()

myButton104 = Button(DebugData1, text="Data1 (Save Slot 2): Kvlar Armour + MilitaryXXX Backpack", command=myClick104, fg="orange", bg="black")
myButton104.pack()

myButton105 = Button(DebugData2, text="Data2 (Save Slot 3): Kvlar Armour + MilitaryXXX Backpack", command=myClick105, fg="orange", bg="black")
myButton105.pack()
...
message05 = Label(DebugData0, text="====================================")
message05.pack()
...
myButton41.pack()
message06 = Label(DebugData1, text="====================================")
message06.pack()
...
message07 = Label(DebugData2, text="====================================")
message07.pack()
...
message03.pack()
message04 = Label(root1, text=" ")
message04.pack()

myButton87 = Button(root1, text="Data0 (Save Slot 1): ATTEMPT TO FIX SAVE FILE", command=myClick87, fg="black", bg="orange")
myButton87.pack()

myButton88 = Button(root1, text="Data1 (Save Slot 2): ATTEMPT TO FIX SAVE FILE", command=myClick88, fg="black", bg="orange")
myButton88.pack()

myButton89 = Button(root1, text="Data2 (Save Slot 3): ATTEMPT TO FIX SAVE FILE", command=myClick89, fg="black", bg="orange")
myButton89.pack()
